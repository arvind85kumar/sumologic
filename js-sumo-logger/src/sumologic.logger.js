...
(function(window, document) {
    ...
    function SumoLogger() {
        ...
        this.endpoint = 'https://endpoint4.collection.sumologic.com/receiver/v1/http/ZaVnC4dhaV2lj3Q944bxnLSZGFEcgEefzEvbac8VALe-QjI3qvpXA9_8JyZIP8n8g4AKj1djLDpcxgaxIMabyNX8P5sdk0bWhqYaQp-2txyijdEKw84oAQ==';
        this.interval = 0;
        this.session = '';
        this.timestamp = '';
        this.hostName = '';
